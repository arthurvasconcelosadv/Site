...
(function () {
  ...
  function breadcrumb() {
    ...
    const labels = {
      ...
      '/blog/':                        'Blog Jurídico',
      '/blog/index.html':              'Blog Jurídico',
      '/blog/rescisao-indireta.html':  'Rescisão Indireta',
      '/blog/insalubridade.html':      'Insalubridade',
      '/blog/assedio-moral.html':      'Assédio Moral',
      '/blog/acidente-trabalho.html':  'Acidente de Trabalho',
      '/blog/horas-extras.html':       'Horas Extras',
      '/areas/insalubridade.html':     'Insalubridade e Periculosidade',
      '/areas/demissao.html':          'Demissão e Rescisão Indireta',
      '/areas/jornada.html':           'Jornada de Trabalho',
      '/areas/assedio.html':           'Assédio Moral no Trabalho',
      '/areas/acidente.html':          'Acidente de Trabalho',
    };

    if (path.includes('/blog/') && !path.endsWith('/blog/')) {
      items.push({ '@type': 'ListItem', position: pos++, name: 'Blog Jurídico', item: SITE.url + '/blog/' });
    }
